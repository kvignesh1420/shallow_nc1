...
def main():
    ...
    for class_sizes in tqdm(CLASS_SIZES_LIST):
        ...
        for in_features in IN_FEATURES_LIST:
            ...
            for _ in range(REPEAT):
                ...
                act_nc1 = tracker.epoch_activation_features_nc_metrics[epochs[-1]][0][
                    "trace_S_W_div_S_B"
                ]
    ...
    plot_dfs(
        ...
        name="act_nc1_{}_h_{}_mu_{}_std_{}_L_{}_N_{}_C_{}_imbalanced.jpg".format(
            activation, fig_h, fig_mu, fig_std, fig_L, fig_N, fig_C
        ),
        context=context,
    )
    plot_rel_dfs(
        dfs=act_rel_dfs,
        CLASS_SIZES_LIST=CLASS_SIZES_LIST,
        name="act_rel_nc1_{}_h_{}_mu_{}_std_{}_L_{}_N_{}_C_{}_imbalanced.jpg".format(
            activation, fig_h, fig_mu, fig_std, fig_L, fig_N, fig_C
        ),
        context=context,
    )
