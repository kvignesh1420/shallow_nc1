        ...
        for annealing_factor in tqdm(self.context["annealing_factors"]):
            ...
            if self.context["eos_update_strategy"] == "default":
                ...
                new_Sigma = scipy.optimize.newton_krylov(
                    F, Sigma, verbose=False, f_tol=5e-3, maxiter=100, inner_maxiter=100
                )
...
def main():
    ...
    plot_dfs(
        dfs=ak_dfs,
        N_LIST=N_LIST,
        name="ak_nc1_erf_h_{}_mu_{}_std_{}_C_{}_balanced.jpg".format(
            fig_h, fig_mu, fig_std, C
        ),
        context=context,
    )
    plot_rel_dfs(
        dfs=ak_rel_dfs,
        N_LIST=N_LIST,
        name="ak_rel_nc1_erf_h_{}_mu_{}_std_{}_C_{}_balanced.jpg".format(
            fig_h, fig_mu, fig_std, C
        ),
        context=context,
    )
